    ...
    ! function(n) {
        ...
        function t(e) {
            1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (n("html").removeAttr("dir"), n(
                ...
                "#bootstrap-style").attr("href", "{{ asset('assets/css/bootstrap.min.css') }}"), n(
                "#app-style").attr("href",
                "{{ asset('assets/css/app.min.css') }}"), sessionStorage.setItem("is_visited",
                ...
                "#bootstrap-style").attr("href", "{{ asset('assets/css/bootstrap-dark.min.css') }}"), n(
                "#app-style").attr(
                "href", "{{ asset('assets/css/app-dark.min.css') }}"), sessionStorage.setItem("is_visited",
                "dark-mode-switch")) : 1 == n("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (n(
                    ...
                    "#bootstrap-style").attr("href", "{{ asset('assets/css/bootstrap-rtl.min.css') }}"), n(
                    "#app-style").attr(
                    "href", "{{ asset('assets/css/app-rtl.min.css') }}"), n("html").attr("dir", "rtl"),
