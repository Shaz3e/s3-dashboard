            ...
            <div class="container">
                <div class="row mx-5 m-2">
                    <div class="col-12 text-center">
                        <h4>{{ __('auth.heading.forgot') }}</h4>
                        <p>{{ __('auth.message.forgot') }}</p>
                    </div>
                    {{-- /.col --}}
                </div>
                {{-- /.row --}}
                ...
                <div class="mx-5">
                    <form action="{{ route('forgot.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <x-form.button text="{{ __('auth.button.send_password_reset_link') }}"
                                    icon="ri-arrow-right-line" iconPosition="right" />
                            </div>
